...
- [x] manual_limitカラム追加 ✅ **本番環境実行済み (2025-11-23)** | マイグレーションファイル: `20250124000001_add_missing_columns.sql`
- [x] portal_siteカラム追加 ✅ **本番環境実行済み (2025-11-23)** | マイグレーションファイル: `20250124000001_add_missing_columns.sql`
- [x] return_itemカラム追加 ✅ **本番環境実行済み (2025-11-23)** | マイグレーションファイル: `20250123000001_add_return_item.sql`
- [x] prefectureカラム追加 (donations) ✅ **本番環境実行済み (2025-11-23)** | マイグレーションファイル: `20250124000001_add_missing_columns.sql`
- [x] municipalityカラム追加 (donations) ✅ **本番環境実行済み (2025-11-23)** | マイグレーションファイル: `20250124000001_add_missing_columns.sql`

**マイグレーション履歴の記録**: 2025-11-24 - 本番環境で既に実行済みのマイグレーションを履歴として記録するため、`20250124000001_add_missing_columns.sql`を作成。`IF NOT EXISTS`を使用して冪等性を確保。
